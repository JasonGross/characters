...
SUCCESS_FILE = 'classification.input.reject.success'
REJECT_FILE = 'classification.input.reject'
UNREVIEWED_PATH = CLASSIFICATION_UNREVIEWED_PATH
...
if __name__ == '__main__':
    ...
    for file_name in args.files_to_convert:
        if os.path.exists(file_name) and os.path.isfile(file_name):
            ...
            convert_hit(hit, pseudo=False, path=os.path.join(UNREVIEWED_PATH, args.path), exclude_rejected=args.exclude_rejected)#False)
        else:
