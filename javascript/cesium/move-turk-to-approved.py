...
dict_list = [{'list':turk_rejected_image_list, 'old path':TURK_REJECTED_IMAGES_PATH, 'path':REJECTED_IMAGES_PATH, 'name':'rejected images'},
             {'list':turk_rejected_strokes_list, 'old path':TURK_REJECTED_STROKES_PATH, 'path':REJECTED_STROKES_PATH, 'name':'rejected strokes'},
             {'list':turk_rejected_extra_info_file_name, 'old path':TURK_REJECTED_EXTRA_INFO_PATH, 'path':REJECTED_EXTRA_INFO_PATH, 'name':'rejected info'},
             {'list':turk_accepted_image_list, 'old path':TURK_ACCEPTED_IMAGES_PATH, 'path':ACCEPTED_IMAGES_PATH, 'name':'accepted images'},
             {'list':turk_accepted_strokes_list, 'old path':TURK_ACCEPTED_STROKES_PATH, 'path':ACCEPTED_STROKES_PATH, 'name':'accepted strokes'},
             {'list':turk_accepted_extra_info_file_name, 'old path':TURK_ACCEPTED_EXTRA_INFO_PATH, 'path':ACCEPTED_EXTRA_INFO_PATH, 'name':'accepted info'}]

if MOVE_ALL:
    dict_list += [{'list':turk_image_list, 'old path':TURK_IMAGES_PATH, 'path':EXTRA_IMAGES_PATH, 'name':'extra images'},
                  {'list':turk_strokes_list, 'old path':TURK_STROKES_PATH, 'path':EXTRA_STROKES_PATH, 'name':'extra strokes'},
                  {'list':turk_extra_info_file_name, 'old path':TURK_EXTRA_INFO_PATH, 'path':EXTRA_EXTRA_INFO_PATH, 'name':'extra info'}]
