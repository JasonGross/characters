#!/usr/bin/python
# record-duplication-completion-submission.py -- Stores the data from the duplication/completion task submission
from __future__ import with_statement
import cgi, cgitb
import argparse
import os
cgitb.enable(format="html")
from recordduplicationcompletionsubmission import record_submission
from alphabetspaths import DUPLICATION_COMPLETION_UNREVIEWED_PATH

DEFAULT_PATH = DUPLICATION_COMPLETION_UNREVIEWED_PATH
