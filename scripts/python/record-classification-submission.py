#!/usr/bin/python
# record-classification-submission.py -- Stores the data from the classification task submission
...
from alphabetspaths import CLASSIFICATION_UNREVIEWED_PATH

DEFAULT_PATH = CLASSIFICATION_UNREVIEWED_PATH

parser = argparse.ArgumentParser(description='Stores data from the classification task submission')
